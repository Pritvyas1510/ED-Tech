...
exports.getSections = async (req, res) => {
    try {
      ...
      const course = await Course.findById(courseId).populate("courseContent"); // courseContent = array of sections
      ...
      return res.status(500).json({ message: "Something went wrong while fetching sections" });
    }
  };
// ================ update Section ================
