...
// ================ create new course ================
    exports.createCourse = async (req, res) => {
        try {
            ...
            // If instructions or tags are being sent as arrays, no need to parse them
            const tag = _tag;
            ...
            // Check if the user is an instructor (this comes from the JWT payload, assuming you have middleware for authentication)
